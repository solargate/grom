...
Unter Android kann **Integration** Health Sync + Google Drive Sync aktivieren. Health Sync schreibt Aktivitäts-CSV/FIT/GPX nach Drive; Grom importiert sie über den Sync-Button auf Home. Setup und OAuth: [Health Sync + Google Drive](../integrations/health-sync-google-drive.md).
