...
When the operator enables captcha (`auth.captcha.enabled`), sign-in, registration, and forgot-password show an **I'm not a robot** checkbox. Complete it before submitting; password reset from the email link does not require captcha.
