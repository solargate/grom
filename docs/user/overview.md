...
Tap another athlete (avatar or name on a workout card or detail, a row in **User search**, someone in Following/Followers, or a liker/comment author) to open their profile. Your own taps do nothing. On someone else’s profile you can Follow or Unfollow, open their Following/Followers lists (and open further profiles from there), and browse their workouts like the home feed. Opening a workout from that list uses the normal detail screen; system Back returns to the previous profile or screen.
