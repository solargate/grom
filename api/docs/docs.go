...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.deleteAccountRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/v1.EquipmentResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.CreateEquipmentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.UpdateEquipmentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/integrations/strava/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Strava bulk export ZIP (multipart)",
                        "name": "archive",
                        "in": "formData"
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/v1.StravaImportStatusResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid or too large archive",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/integrations/strava/import/status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/social/follow": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid follow target",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/users/search": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Federated user not found",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    }
        ...
        "/workouts": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "number",
                        "description": "Max speed km/h (multipart); preserved when set with a track",
                        "name": "speed_max_kmh",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "Average speed km/h (multipart); preserved when set with a track",
                        "name": "speed_avg_kmh",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "Elevation gain meters (multipart); preserved when set with a track",
                        "name": "elevation_gain",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "Lowest elevation meters (multipart); preserved when set with a track",
                        "name": "elevation_low",
                        "in": "formData"
                    },
                    {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid workout data or track",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.ExternalIDExistsResponse"
                        }
                    },
                    "400": {
        ...
        "/workouts/parse-track": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Track file required or invalid",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/workouts/{id}/comments": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid or empty comment",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/workouts/{id}/comments/{commentId}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Workout or comment not found",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.WorkoutHeartRateResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/workouts/{id}/likes": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Cannot like own workout",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/workouts/{id}/map-preview": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Map preview not found",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    }
        ...
        "/workouts/{id}/media": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Photo files (repeatable)",
                        "name": "photos",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Photos required or invalid",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
        ...
        "/workouts/{id}/media/{filename}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Workout or photo not found",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.WorkoutSpeedResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/workouts/{id}/track": {
            "get": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Original track download not allowed",
                        "schema": {
                            "$ref": "#/definitions/v1.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "v1.ExternalIDRequest": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string",
                    "example": "CYCLING 2026.07.30 16.26 Strava.csv"
                },
                "name": {
                    "type": "string",
        ...
        "v1.StravaImportStatusResponse": {
            ...
            "properties": {
                ...
                "result": {
                    "$ref": "#/definitions/v1.StravaImportResultResponse"
                },
                "upload_progress": {
                    "type": "number",
                    "example": 1
        ...
        "v1.WorkoutHeartRateResponse": {
            ...
            "properties": {
                ...
                "samples": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.WorkoutHeartRateSampleResponse"
                    }
                }
            }
        },
        "v1.WorkoutHeartRateSampleResponse": {
            "type": "object",
            "properties": {
                "distance_m": {
                    "type": "number",
        ...
        "v1.WorkoutResponse": {
            ...
            "properties": {
                ...
                "equipment": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.WorkoutEquipmentItem"
                    }
                },
                "external_id": {
                    "$ref": "#/definitions/v1.ExternalIDRequest"
        ...
        "v1.WorkoutSpeedResponse": {
            "type": "object",
            "properties": {
                "samples": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.WorkoutSpeedSampleResponse"
                    }
                },
                "speed_avg_kmh": {
                    "type": "number",
